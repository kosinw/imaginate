            ...
            <div className="inline-block align-bottom bg-background rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-background px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-emerald-500 sm:mx-0 sm:h-10 sm:w-10">
                    <HiPlus className="h-6 w-6 text-indigo-100" aria-hidden="true" />
                  </div>
                  <form onSubmit={handleSubmit(onSubmit)} className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 flex flex-col space-y-4">
                      <p className="text-sm text-gray-200">
                        By creating an animation you are recognizing that you hold the sole authority to{" "}
                        <b>delete</b> this animation; however, others do have the authority to add on to this animation.
                      </p>
