...
export default function ForkDialog({ open, setOpen, onFork, defaultFrame }) {
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 flex flex-col space-y-4">
                      <p className="text-sm text-gray-200">
                        By forking this animation, you are creating your own copy whose changes will have no effect on the original.
                      ...
                      <fieldset className="flex flex-col space-y-1">
                        ...
                        <input className="rounded-sm border border-gray-600 py-px px-2" />
                      </fieldset>
                      <fieldset className="flex flex-col space-y-1">
                        <label className="text-sm text-gray-200">Frame</label>
                        <input defaultValue={defaultFrame} className="rounded-sm border border-gray-600 py-px px-2" />
                      </fieldset>
                    </div>
